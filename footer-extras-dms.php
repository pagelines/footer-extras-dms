			...
			array(
				...
				'opts'	=> array(
					...
					array(
						...
						'type' 			=> 'check',			
						'label'	=> 'Show The Business NAP (Name, Address, Phone)?'
					),
					array(
						'key'			=>	'nap_name',
						'type' 			=> 'text',			
